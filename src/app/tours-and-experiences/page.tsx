...
export const metadata: Metadata = {
  ...
  description: "Exclusive luxury tours throughout Alberta, including Banff luxury tours, Lake Louise explorer, and Southern Alberta sightseeing experiences with Lux Limousine Service.",
};
...
const tourSchema = {
  ...
  "description": "A luxury guided tour of Banff National Park and Lake Louise with stops at Johnston Canyon, Emerald Lake, and other scenic locations.",
...
const transferServices = [
  {
    ...
    description: "24/7 service, meet-and-greet, chilled water, luggage assistance.",
    image: "https://images.unsplash.com/photo-1530521954074-e64f6810b32d?w=800",
  },
  {
    title: "Game-Day Transfers",
    description: "Calgary or Edmonton pro games, tournaments up to fifteen passengers.",
    image: "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?w=800",
  },
  {
    title: "Sedan & SUV Shuttle",
    description: "Weddings, grads, stags & stagettes, birthdays, pub crawls (party bus coming soon).",
    image: "https://images.unsplash.com/photo-1563803835717-b6aeba87a435?w=800",
  },
];
...
const fleetVehicles = [
  {
    ...
    image: "https://images.unsplash.com/photo-1570733577524-3a047079e80d?w=800",
  },
  {
    name: "Mercedes Sprinter",
    maxPassengers: 14,
    amenities: ["WiFi", "Premium Audio", "TV Screens", "Climate Control"],
    image: "https://images.unsplash.com/photo-1517264862896-147a2a0d5e94?w=800",
  },
  {
    name: "Executive Coach",
    maxPassengers: 24,
    amenities: ["WiFi", "Restroom", "Entertainment System", "Luxury Seating"],
    image: "https://images.unsplash.com/photo-1570125693278-4cc5d3cc8b3e?w=800",
  },
];
    ...
    <>
      ...
      <div className="relative min-h-screen flex items-center justify-center">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-32 pb-20 text-center">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold mb-6 text-shadow-lg" data-aos="fade-up">
            <span className="text-primary">Exclusive Mountain &</span>
            <br /> Heritage Tours
          </h1>
          <div className="h-1 w-32 bg-primary mx-auto my-8 shadow-glow" data-aos="fade-up" data-aos-delay="100"></div>
      ...
      <section className="bg-secondary-dark py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-serif font-bold mb-6" data-aos="fade-up">
              Signature <span className="text-primary">Day Tours</span>
            </h2>
            <div className="h-1 w-24 bg-primary mx-auto" data-aos="fade-up" data-aos-delay="100"></div>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-7xl mx-auto">
            {/* Banff & Lake Louise Explorer */}
            <div className="bg-secondary rounded-lg overflow-hidden shadow-xl border border-primary/10" data-aos="fade-up">
              <div className="p-8">
                ...
                <div className="mb-10 bg-secondary-light p-6 rounded-lg shadow-inner border border-primary/10">
                  <h4 className="text-xl font-serif mb-4 text-primary">Alternate photo-focused loop</h4>
                  <div className="flex flex-wrap gap-2">
                    {alternateLoop.map((location, index) => (
                      <span key={index} className="inline-flex items-center bg-secondary border border-primary/30 px-3 py-1 rounded-md text-gray-300">
            ...
            <div className="bg-secondary rounded-lg overflow-hidden shadow-xl border border-primary/10" data-aos="fade-up" data-aos-delay="100">
              <div className="p-8">
                <h3 className="text-2xl md:text-3xl font-serif font-bold mb-6 text-primary">
                  Southern Alberta Heritage Loop
                </h3>
                  ...
                  {heritageAttractions.map((attraction, index) => (
                    ...
                    >
                      ...
                      <div className="p-3 bg-secondary-light">
                        <h4 className="text-sm font-medium text-white truncate">{attraction.title}</h4>
                        <p className="text-xs text-gray-400">{attraction.town}</p>
            ...
            {transferServices.map((service, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-end">
                  <h3 className="text-2xl font-serif font-bold mb-3 text-primary">{service.title}</h3>
                  <p className="text-gray-300 mb-6">{service.description}</p>
                  <Link
                    href={`/booking?service=${service.title.toLowerCase().replace(/\s+/g, '-')}`}
      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex overflow-x-auto pb-8 gap-8 hide-scrollbar" data-aos="fade-up">
            {fleetVehicles.map((vehicle, index) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-serif font-bold mb-2 text-primary">{vehicle.name}</h3>
                  <div className="flex items-center gap-2 mb-4">
                    <svg className="h-5 w-5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                    <span className="text-gray-300">Up to {vehicle.maxPassengers} passengers</span>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {vehicle.amenities.map((amenity, i) => (
                      <span key={i} className="text-xs bg-secondary px-2 py-1 rounded-md text-gray-400">
                        {amenity}
                      </span>
                    ))}
                  </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-secondary-dark bg-opacity-90 border-t border-primary/20 p-4 z-40 backdrop-blur-sm hidden md:block">
        <div className="container mx-auto flex justify-center gap-6">
          <Link href="tel:4036058133" className="flex items-center gap-2 text-primary hover:text-primary-light transition-colors">
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
            </svg>
            Call
          </Link>
          <a href="https://wa.me/4036058133" className="flex items-center gap-2 text-primary hover:text-primary-light transition-colors">
          ...
          <Link href="/booking?tour=instant-quote" className="flex items-center gap-2 text-primary hover:text-primary-light transition-colors">
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
