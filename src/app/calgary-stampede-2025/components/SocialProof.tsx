      ...
      <Container>
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 bg-red-600/20 backdrop-blur-sm rounded-full px-6 py-3 border border-red-600/30">
            ...
            <span className="text-white font-medium">{bookingUpdates[currentUpdate]}</span>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-gray-900 rounded-lg p-8 border border-gray-800">
            ...
            <p className="text-lg text-gray-300 mb-4 italic">"{testimonials[currentTestimonial].text}"</p>
            <p className="text-gold font-medium">- {testimonials[currentTestimonial].name}</p>
          </div>
        </div>
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-4 text-center">
          <div className="bg-gold/10 rounded-lg p-4 border border-gold/30">
            ...
            <p className="text-sm text-gray-300">Only 3 Escalades left for Parade Day</p>
          </div>
          <div className="bg-gold/10 rounded-lg p-4 border border-gold/30">
            <p className="text-gold font-bold">🎯 Early Bird Special</p>
            <p className="text-sm text-gray-300">Book now for 10% off July dates</p>
          </div>
          <div className="bg-gold/10 rounded-lg p-4 border border-gold/30">
            <p className="text-gold font-bold">🌟 Artist Approved</p>
            <p className="text-sm text-gray-300">Trusted by performers at all major venues</p>
          </div>
        </div>
      </Container>
    </section>
