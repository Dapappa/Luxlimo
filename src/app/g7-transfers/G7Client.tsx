...
export default function G7Client() {
  return (
    <main>
      {/* Hero section with Banff video background */}
      <div className="relative pt-32 pb-24 bg-secondary-dark overflow-hidden">
        {/* Banff video background */}
        ...
        {/* Hero content overlaying the video */}
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">
            G7 Summit Transfers
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Premium & Secure Transportation for Delegates and Events
          </p>
        </div>
      </div>
